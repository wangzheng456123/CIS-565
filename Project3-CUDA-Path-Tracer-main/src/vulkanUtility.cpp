...
namespace vulkanUtility {
	...
	void createDescriptorSetLayout() {
		...
		std::array<VkDescriptorSetLayoutBinding, 2> bingdings = {samplerBinding };
	...
	void initImGUI(ImGui_ImplVulkan_InitInfo& vulkanInit) {
		...
		vulkanInit.UseDynamicRendering = VK_TRUE;
	}
